...
Overlay.prototype.render = function () {
  var overlayLink = document.createElement('a'),
      ...
      daydreamLink = document.createElement('a'),
      daydreamLinkWrap = document.createElement('div'),
      daydreamClose = document.createElement('div');

  overlayLink.textContent = '› Use Proxy';
  overlayLink.href = this.linkUrl + '/#/connect';
  overlayLink.target = '_blank';
  overlayLink.classList.add('overlay-link');

  daydreamLink.textContent = '› Daydream Remote';
  daydreamLink.classList.add('overlay-link');
  daydreamLink.setAttribute('id', 'daydreamLink');

  this.el.textContent = 'Proxy Pair Code: “' + this.pairCode + '”';
  ...
  overlayLinkWrap.appendChild(daydreamLink);
